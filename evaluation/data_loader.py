...
def load_data(data_name, split, data_dir="./data"):
    ...
    if os.path.exists(data_file):
        ...
        if data_name == "math":
            if split == 'self-evolve':
                examples = list(load_jsonl(f"{data_dir}/{data_name}/{split}.jsonl"))
        ...
        elif data_name == "mathmetics":
            with open('./evaluation/data/mathmetics/test.json')as f:
